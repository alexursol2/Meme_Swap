...
export const poolMemecoin1Account = new Web3.PublicKey(
    "BVPUZrv5nk3jMyTWkZdxvp2LuyPF1DmGTyR8AzKvgZgN"
)

export const poolMemecoin2Account = new Web3.PublicKey(
    "5ttkBtMndCbHdSib22K4wRUE5ifprPXkMSckzBRSQv3K"
)

export const ourpoolMint = new Web3.PublicKey(
    "CXQYDT9ShDYG1JMMwjNiR6TcL4u4uJNnguAbLKw6jVv4"
)

/*export const ourtokenAccountPool = new Web3.PublicKey(
...
export const Memecoin1Mint = new Web3.PublicKey(
    "DWiD4EVUtnsgqoGbdSK5kBjHRJ7XoGx58WPHBu7t73Dh"
)

export const Memecoin2Mint = new Web3.PublicKey(
